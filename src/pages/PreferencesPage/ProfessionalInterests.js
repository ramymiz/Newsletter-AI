...
const interests = {
    ...
    Sustainability: ['Environmental Policy', 'Climate Change Mitigation', 'Conservation Biology', 'Waste Management', 'Energy Efficiency', 'Sustainable Development',],
    ...
    Energy: ['Renewable Energy', 'Oil & Gas Exploration', 'Oil & Gas Refining', 'Natural Gas Distribution', 'Energy Policy', 'Energy Storage', 'Energy Engineering',],
