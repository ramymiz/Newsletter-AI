...
const interests = {
    ...
    Sustainability: ['Environmental Policy', 'Climate Change Mitigation', 'Renewable Energy', 'Conservation Biology', 'Waste Management', 'Energy Efficiency', 'Sustainable Development',],
    ...
    Energy: ['Renewable Energy', 'Oil & Gas Exploration', 'Oil & Gas Refining', 'Natural Gas Distribution', 'Energy Policy', 'Energy Efficiency', 'Energy Storage', 'Energy Engineering',],
